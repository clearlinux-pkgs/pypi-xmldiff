...
Source0  : https://files.pythonhosted.org/packages/55/d8/b31a4d75bc72d5c3a5adf5012405118169b56d163ebf407e4fc49a575e96/xmldiff-2.7.0.tar.gz
...
%prep
%setup -q -n xmldiff-2.7.0
cd %{_builddir}/xmldiff-2.7.0
pushd ..
cp -a xmldiff-2.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715623894
